//
//  ThreadAnswerGroupUserTableViewCell.swift
//  Qv1
//
...
class ThreadAnswerGroupUserTableViewCell: UITableViewCell {

    @IBOutlet weak var answerGroupMemberNameLabel: UILabel!
    
    @IBOutlet weak var answerGroupMemberImageView: UIImageView!
    
    @IBOutlet weak var selectAnswerGroupMemberButton: UIButton!
